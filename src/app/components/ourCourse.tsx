...
const courses = [
    ...
    { title: "Film Poster Design", tag: "Crash course", duration: "3 months", description: "Create cinematic poster concepts through typography, composition and retouching.", image: null, icon: WandSparkles, number: "03", color: "#ffbc77", topics: ["Film poster concepts", "Typography and visual hierarchy", "Image composition and retouching", "Campaign-ready artwork"] },
    { title: "Digital Marketing with AI Tools", tag: "AI marketing", duration: "3 months", description: "Plan creative campaigns and social content with modern AI marketing tools.", image: null, icon: Bot, number: "04", color: "#c3adff", topics: ["Digital campaign planning", "Social content and creative strategy", "AI tools for marketing workflows", "Measuring and improving results"] },
];
